...
This project is configured for Cloudflare Pages deployment and is intended to be published via the active Cloudflare site connected to the repository.

For local development and build validation, use:
