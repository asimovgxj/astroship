---
draft: false
title: "Russia: The ICE Export Dividend and the Scrapping Tax Impact"
...
<div class="my-8 flex justify-center">
  <svg width="400" height="250" viewBox="0 0 400 250" fill="none" xmlns="http://www.w3.org" class="w-full max-w-lg rounded-lg border border-slate-100 shadow-sm">
    ...
    <text x="20" y="30" fill="#0f172a" font-weight="bold" font-size="12">Price Breakdown: Shanghai vs. Moscow (2.0L SUV)</text>
    <rect x="50" y="180" width="80" height="40" fill="#10b981" />
    <text x="50" y="235" fill="#64748b" font-size="9">SHANGHAI MSRP</text>
    <rect x="250" y="180" width="80" height="40" fill="#10b981" />
...
- **The Premium Segment:** For high-end vehicles above the $50,000 threshold, the $6,000 tax hike is a manageable **8-10%** cost increase. These buyers allow OEMs to maintain a **15-20% net margin** by passing the tax burden directly to the retail price.
- **The Mass-Market Squeeze:** In the $20,000 SUV segment, the **Russia car scrapping tax** now represents nearly **30%** of the landed value. To remain viable, exporters are forced to compress margins to as low as **5-8%**.
